...
import config
from HanzzMusic import LOGGER, YouTube, app
...
from HanzzMusic.utils.inline.play import stream_markup, telegram_markup
    ...
    async def stream_call(self, link):
        try:
            ...
            LOGGER(__name__).warning(
                "Skipping startup stream check: %s", type(exc).__name__
            )
